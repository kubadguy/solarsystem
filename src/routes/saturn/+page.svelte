<script>
	...
	function submitQuiz() {
		const answerKey = { q1: 'giant', q2: ['a','b'], q3: 'rings', q4: 'b', q5: 'true' };
		let tally = 0;
...
<main class="saturn-page">
	...
	<section class="panels">
		<article class="panel" data-active={activeSection === 'id-overview'} id="id-overview">
			<h2>Overview</h2>
			<p>Gas giant famous for bright rings.</p>
			<p>Rings of ice and rock.</p>
		</article>
