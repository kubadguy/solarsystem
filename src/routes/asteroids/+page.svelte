...
<main class="asteroids-page">
	...
	<section class="panels">
		<article class="panel" data-active={activeSection === 'id-overview'} id="id-overview">
			<h2>Overview</h2>
			<p>Small rocky bodies orbiting the Sun.</p>
			<p>Many live in the asteroid belt.</p>
		</article>
