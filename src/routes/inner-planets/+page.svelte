<script>
	...
	const factsBySection = {"id-overview": [{"title": "Core Idea", "text": "What it is and where it belongs."}, {"title": "Key Detail", "text": "Key identity facts to remember."}, {"title": "Quick Clue", "text": "Mercury, Venus, Earth, Mars."}, {"title": "Remember", "text": "Small and rocky."}, {"title": "Extra", "text": "Remember this point."}], "id-members": [{"title": "Core Idea", "text": "Group members."}, {"title": "Key Detail", "text": "Order and key traits."}, {"title": "Quick Clue", "text": "Mercury, Venus, Earth, Mars."}, {"title": "Remember", "text": "Small and rocky."}, {"title": "Extra", "text": "Remember this point."}], "id-features": [{"title": "Core Idea", "text": "Shared features."}, {"title": "Key Detail", "text": "Rings, storms, and size."}, {"title": "Quick Clue", "text": "Mercury, Venus, Earth, Mars."}, {"title": "Remember", "text": "Small and rocky."}, {"title": "Extra", "text": "Remember this point."}], "id-distance": [{"title": "Core Idea", "text": "Distance from the Sun."}, {"title": "Key Detail", "text": "Longer years and colder temps."}, {"title": "Quick Clue", "text": "Mercury, Venus, Earth, Mars."}, {"title": "Remember", "text": "Small and rocky."}, {"title": "Extra", "text": "Remember this point."}], "id-compare": [{"title": "Core Idea", "text": "Compare size and atmosphere."}, {"title": "Key Detail", "text": "What makes each unique."}, {"title": "Quick Clue", "text": "Mercury, Venus, Earth, Mars."}, {"title": "Remember", "text": "Small and rocky."}, {"title": "Extra", "text": "Remember this point."}], "id-quiz": [{"title": "Core Idea", "text": "Test yourself with harder questions."}, {"title": "Key Detail", "text": "Try to answer without guessing."}, {"title": "Quick Clue", "text": "Mercury, Venus, Earth, Mars."}, {"title": "Remember", "text": "Small and rocky."}, {"title": "Extra", "text": "Remember this point."}]};
...
<main class="inner-planets-page">
	<section class="top">
		<div class="title">
			<p class="tag">Rocky Team</p>
			<h1>Inner Planets</h1>
			<p class="subtitle">Mercury, Venus, Earth, Mars.</p>
		</div>
		<nav class="jump">
					<button
						type="button"
	...
	<section class="inner-planets-layout">
		<div class="inner-planets-core" aria-hidden="true">
			<div class="inner-planets-sphere"></div>
			<div class="inner-planets-halo"></div>
		</div>
...
<style>
	...
	.inner-planets-page { min-height: 100svh; padding: clamp(1.5rem, 4vw, 3rem); display: grid; gap: clamp(1.2rem, 2.4vw, 2.2rem); }
	...
	.inner-planets-layout { position: relative; min-height: 320px; display: grid; place-items: center; }
	.inner-planets-core { position: relative; width: min(240px, 40vw); aspect-ratio: 1; border-radius: 50%; display: grid; place-items: center; filter: drop-shadow(0 20px 50px rgba(150, 180, 255, 0.35)); }
	.inner-planets-sphere { position: absolute; inset: 0; border-radius: 50%; background: radial-gradient(circle at 30% 30%, rgba(220, 235, 255, 0.9), transparent 40%), radial-gradient(circle at 70% 60%, rgba(140, 170, 230, 0.6), transparent 50%), radial-gradient(circle at 50% 50%, #cbd8f2, #7aa0d6 60%, #3c5e9c 100%); animation: slowspin 22s linear infinite; }
	.inner-planets-halo { position: absolute; inset: -8%; border-radius: 50%; background: radial-gradient(circle, rgba(150, 180, 255, 0.35), transparent 70%); filter: blur(6px); animation: pulse 4s ease-in-out infinite; }
	...
	@media (max-width: 900px) { .top { grid-template-columns: 1fr; } .jump { grid-template-columns: repeat(3, minmax(0, 1fr)); } .fact { display: none; } .inner-planets-layout { min-height: 240px; } }
</style>
