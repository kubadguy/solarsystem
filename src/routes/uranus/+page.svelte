<script>
	...
	const factsBySection = {'id-overview': [{'title': 'Overview', 'text': 'Basic facts and identity.'}, {'title': 'Overview', 'text': 'Where it is and what it is made of.'}, {'title': 'Overview', 'text': 'Key traits you can remember.'}, {'title': 'Overview', 'text': 'Why it matters.'}, {'title': 'Overview', 'text': 'Tilted about 98 degrees.'}], 'id-color': [{'title': 'Color', 'text': 'Blue color from methane.'}, {'title': 'Color', 'text': 'Haze and clouds.'}, {'title': 'Color', 'text': 'Subtle color shifts.'}, {'title': 'Color', 'text': 'Bright spots.'}, {'title': 'Color', 'text': 'Why color matters.'}], 'id-storms': [{'title': 'Storms', 'text': 'Big storms and bands.'}, {'title': 'Storms', 'text': 'Fast winds and jets.'}, {'title': 'Storms', 'text': 'Long-lasting weather.'}, {'title': 'Storms', 'text': 'Energy from inside.'}, {'title': 'Storms', 'text': 'Storm colors and shapes.'}], 'id-moons': [{'title': 'Moons', 'text': 'Major moons to know.'}, {'title': 'Moons', 'text': 'Icy and rocky types.'}, {'title': 'Moons', 'text': 'Interesting features.'}, {'title': 'Moons', 'text': 'Possible oceans.'}, {'title': 'Moons', 'text': 'Moon systems.'}], 'id-rings': [{'title': 'Rings', 'text': 'Rings made of ice and dust.'}, {'title': 'Rings', 'text': 'Thin but wide rings.'}, {'title': 'Rings', 'text': 'Gaps and divisions.'}, {'title': 'Rings', 'text': 'Ring colors.'}, {'title': 'Rings', 'text': 'Changes over time.'}], 'id-quiz': [{'title': 'Mini Test', 'text': 'Think deep.'}, {'title': 'Mini Test', 'text': 'Short answers and multi-select.'}, {'title': 'Mini Test', 'text': 'Be precise.'}, {'title': 'Mini Test', 'text': 'Reason it out.'}, {'title': 'Mini Test', 'text': 'Challenge mode.'}]};
	...
	function submitQuiz() {
		const answerKey = { q1: 'ice', q2: ['a','b'], q3: '84', q4: 'b', q5: 'true' };
		let tally = 0;
...
<main class="uranus-page">
	...
	<section class="uranus-layout">
		<div class="uranus-core" aria-hidden="true">
			<div class="uranus-sphere"></div>
			<div class="uranus-halo"></div>
		</div>
	...
	<section class="panels">
		<article class="panel" data-active={activeSection === 'id-overview'} id="id-overview">
			<h2>Overview</h2>
			<p>Icy giant tilted on its side.</p>
			<p>Tilted about 98 degrees.</p>
		</article>
...
<style>
	...
	.uranus-page { min-height: 100svh; padding: clamp(1.5rem, 4vw, 3rem); display: grid; gap: clamp(1.2rem, 2.4vw, 2.2rem); }
	...
	.uranus-layout { position: relative; min-height: 320px; display: grid; place-items: center; }
	.uranus-core { position: relative; width: min(240px, 40vw); aspect-ratio: 1; border-radius: 50%; display: grid; place-items: center; filter: drop-shadow(0 20px 50px rgba(120, 210, 255, 0.35)); }
	.uranus-sphere { position: absolute; inset: 0; border-radius: 50%; background: radial-gradient(circle at 30% 30%, rgba(220, 250, 255, 0.9), transparent 40%), radial-gradient(circle at 70% 60%, rgba(120, 210, 255, 0.6), transparent 50%), radial-gradient(circle at 50% 50%, #b2e6ff, #6ac7e8 60%, #2f7fa8 100%); animation: slowspin 22s linear infinite; }
	.uranus-halo { position: absolute; inset: -8%; border-radius: 50%; background: radial-gradient(circle, rgba(120, 210, 255, 0.35), transparent 70%); filter: blur(6px); animation: pulse 4s ease-in-out infinite; }
	...
	@media (max-width: 900px) { .top { grid-template-columns: 1fr; } .jump { grid-template-columns: repeat(3, minmax(0, 1fr)); } .fact { display: none; } .uranus-layout { min-height: 240px; } }
+</style>
